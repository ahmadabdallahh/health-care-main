-- إصلاح جداول نظام التذكيرات والإشعارات
-- Fixed Reminder and Notification System Tables
...
-- إنشاء فهارس لتحسين الأداء (مع التحقق من وجودها)
SET @sql = 'CREATE INDEX IF NOT EXISTS idx_reminder_settings_user ON reminder_settings(user_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_reminder_logs_user ON reminder_logs(user_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_reminder_logs_appointment ON reminder_logs(appointment_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_push_notifications_user ON push_notifications(user_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_push_notifications_read ON push_notifications(is_read)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_working_hours_doctor ON working_hours(doctor_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_appointments_time ON appointments(appointment_time)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_appointments_status ON appointments(status)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_doctors_hospital ON doctors(hospital_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_doctors_active ON doctors(is_active)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_hospitals_city ON hospitals(city_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

SET @sql = 'CREATE INDEX IF NOT EXISTS idx_users_city ON users(city_id)';
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
