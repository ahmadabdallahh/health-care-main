        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="#features" class="text-gray-600 hover:text-blue-600 transition-colors duration-300">المميزات</a>
                    <a href="#specialties" class="text-gray-600 hover:text-blue-600 transition-colors duration-300">التخصصات</a>
                    <a href="#contact" class="text-gray-600 hover:text-blue-600 transition-colors duration-300">تواصل معنا</a>
                </nav>
                ...
                <div class="flex items-center space-x-2 space-x-reverse">
                    <?php if (is_logged_in()): ?>
                        ...
                        ?>
                        <a href="<?php echo $dashboard_url; ?>" class="px-4 py-2 text-sm font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-md">لوحة التحكم</a>
                        <a href="logout.php" class="px-4 py-2 text-sm font-bold text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 transition-all duration-300">تسجيل الخروج</a>
                    <?php else: ?>
                        <a href="login.php" class="px-5 py-2.5 text-sm font-bold text-white bg-green-500 rounded-lg hover:bg-green-600 focus:ring-4 focus:ring-green-300 transition-all duration-300 shadow-md hover:shadow-lg">تسجيل الدخول</a>
                        <a href="register.php" class="px-5 py-2.5 text-sm font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition-all duration-300 shadow-md hover:shadow-lg">إنشاء حساب</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <main>
        ...
        <section id="specialties" class="py-20">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">نغطي كافة التخصصات الطبية لمساعدتك في العثور على الطبيب المناسب لحالتك الصحية.</p>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    ?>
                        <a href="search.php?specialty=<?php echo $specialty['id']; ?>" class="block bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-xl hover:bg-blue-50 hover:-translate-y-2 transition-all duration-300 group">
                            <div class="text-5xl text-blue-600 mb-4 transition-transform duration-300 group-hover:scale-110">
                                <i class="<?php echo $specialty_icons[$i++ % count($specialty_icons)]; ?>"></i>
                            </div>
                            <h3 class="text-lg font-bold text-gray-800"><?php echo htmlspecialchars($specialty['name']); ?></h3>
                        </a>
                    <?php endforeach; ?>
                </div>
            </div>
